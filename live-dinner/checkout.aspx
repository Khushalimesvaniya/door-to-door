<%@ Page Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="checkout.aspx.cs" Inherits="checkout" Title="Untitled Page" %>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="submit-button text-center">
                                        ...
                                        <asp:Button ID="submit" class="btn btn-common" runat="server" Text="Bill"  onclick="submit_Click" />   
